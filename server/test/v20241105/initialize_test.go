...
func TestInitializeResponse_v20241105(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:            "2024-11-05 version request",
			clientVersion:   "2024-11-05",
			expectedVersion: "2024-11-05",
		},
		{
			name:            "version with v prefix",
			clientVersion:   "v2024-11-05",
			expectedVersion: "2024-11-05",
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// 2024-11-05 specific validations
			// Should NOT have sampling capability (that's for clients)
			if _, hasSampling := capabilities["sampling"]; hasSampling {
				t.Errorf("Server should not declare sampling capability in 2024-11-05 spec")
			}
		})
	}
}
...
func TestInitializeResponseWithoutRegistrations_v20241105(t *testing.T) {
